package com.tradevision.alertservice.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, StockPriceEvent> stockPriceConsumerFactory() {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.tradevision.common.event");
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, StockPriceEvent.class);
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, StockPriceEvent>
